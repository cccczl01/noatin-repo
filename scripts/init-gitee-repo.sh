...
if [ ${#PACKAGE_NAMES[@]} -gt 0 ]; then
    ...
    echo "下一步:"
    echo "  git init"
    echo "  git remote add origin git@gitee.com:cccczl01/noatin-repo.git"
...
echo "  git remote add github https://github.com/cccczl01/noatin-repo.git"
echo "  git remote add gitcode https://gitcode.com/cccczl001/noatin-repo.git"
echo ""
echo "首次推送镜像:"
